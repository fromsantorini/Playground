...
4. **Deliver the HTML file.** After writing the HTML file, provide a clickable local file link. In Codex, only launch a browser when the user explicitly asks, because GUI actions may require approval.
